  ...
  (function(_Component) {
    ...
    function TimeGrid(props) {
      ...
      _this.checkOverflow = function() {
        if (!_this.props.showTimeGridHeaderOnly) {
    ...
    _proto.render = function render() {
      var _this$props3 = this.props,
        ...
        hideTimeGutter = _this$props3.hideTimeGutter,
        showTimeGridHeaderOnly = _this$props3.showTimeGridHeaderOnly
...
TimeGrid.propTypes = {
  ...
  showTimeGridHeaderOnly: _propTypes.default.bool,
  hideTimeGutter: _propTypes.default.bool,
